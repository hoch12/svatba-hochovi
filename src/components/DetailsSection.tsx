        ...
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
          ...
          <div className="bg-card p-8 md:p-10 rounded-lg border border-border/50 text-center">
            ...
            <p className="font-body text-muted-foreground leading-relaxed">
              Svatbu nebudeme ladit do konkrétní barvy, proto budeme rádi, když zvolíte oblečení, ve kterém se budete cítit příjemně a&nbsp;elegantně. Pány prosíme, aby se vyhnuli béžové barvě obleku.
            </p>
          </div>
